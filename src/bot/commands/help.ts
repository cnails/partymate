...
export const registerHelp = (bot: Telegraf) => {
  bot.command('help', async (ctx) => {
    ...
    const common = [
      ...
      '• Статусы заявок: 🆕 новая · 💬 переговоры · ✅ принята · 💸 оплата получена · 🏁 завершена · ❎ отклонена · 🚫 отменена.',
      '',
    ].join('\n');
    ...
    await ctx.reply(
      [
        common,
        '🧑‍💻 Для клиентов:',
        '/search [услуга] — найти исполнительницу (например: /search CS2 или просто /search для списка)',
