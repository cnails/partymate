...
const descriptions = [
  'Привет! Буду твоим милым тиммейтом, всегда поддержу и подарю улыбку.',
  'Обожаю помогать в игре, стану заботливым саппортом и подниму тебе настроение.',
  ...
  'Предлагаю посмотреть аниме, что насчет сегодняшнего вечера?',
];
